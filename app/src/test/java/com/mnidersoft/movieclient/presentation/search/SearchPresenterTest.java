...
public class SearchPresenterTest {
    ...
    public void setup() {
        ...
        mView = new MockedSearchView(mOnNext, mOnError, mOnCompleted);
        ...
        mPresenter = new SearchPresenter(mRestClient, mView, coordinator, mStrategist);
    }
    ...
    public void testWithAvailableData() throws Exception {
        ...
        Mockito.when(mRestClient.searchMoviesByTitle(Matchers.anyString(), Matchers.anyInt())).thenReturn(data);

        mPresenter.searchMoviesByTitle("Dragon Ball", 1);
    ...
    public void testWithoutContentData() throws Exception {
        ...
        Mockito.when(mRestClient.searchMoviesByTitle(Matchers.anyString(), Matchers.anyInt())).thenReturn(noContent);
        mPresenter.searchMoviesByTitle("Dragon Ball", 1);
    ...
    public void testWithUnexpectedError() throws Exception {
        ...
        Mockito.when(mRestClient.searchMoviesByTitle(Matchers.anyString(), Matchers.anyInt())).thenReturn(error);
        mPresenter.searchMoviesByTitle("Dragon Ball", 1);
    ...
    public void testWithOtherError() throws Exception {
        ...
        Mockito.when(mRestClient.searchMoviesByTitle(Matchers.anyString(), Matchers.anyInt())).thenReturn(broken);
